...
```mermaid
graph TD
  ThirdPartyWeb[3rd-party Mini App (HTML/JS/CSS)] -- PickMe.invoke --> Bridge["WebBridge (Swift)\nHandlers Map"]
  Bridge -- calls --> NativeCore["Native Core Modules\n(Auth, Payments, API, Analytics)"]
